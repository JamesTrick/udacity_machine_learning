...
select_best_dt = SelectKBest(k=10)
clf_dt = DecisionTreeClassifier()

steps = [('feature_selection', select_best_dt),
        ('model', clf_dt)]

pipeline_dt = sklearn.pipeline.Pipeline(steps)
...
grid_search = GridSearchCV(pipeline_dt, param_grid=parameters)
